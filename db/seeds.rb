...
Recipe.create(name: 'pasta', difficulty: 'hard', prep_time: 30, directions: "test", ingredients: "test", user_id: 2, category: "dinner", image_url: "http://cdn-image.myrecipes.com/sites/default/files/styles/4_3_horizontal_-_1200x900/public/image/lighten-up-america/pasta-vodka-cream-sauce-ck-x.jpg?itok=hNBgMYDa")
